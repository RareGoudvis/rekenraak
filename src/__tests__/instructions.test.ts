...
describe('function-valued instructions cover every setting branch', () => {
    const cases: Array<{ leafId: string; overrides: Record<string, unknown>; expectContains: string }> = [
        ...
        { leafId: 'splitsen-benen', overrides: { maxGetal: 1000 }, expectContains: 'D, H, T en E' },
        { leafId: 'splitsen-benen', overrides: { maxGetal: 100 }, expectContains: 'H, T en E' },
        { leafId: 'splitsen-benen', overrides: { maxGetal: 10 }, expectContains: 'T en E' },
